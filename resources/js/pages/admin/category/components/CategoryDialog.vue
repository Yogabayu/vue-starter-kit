                ...
                <div class="grid grid-cols-1 gap-4">
                    <FormField v-slot="{ componentField }" name="name">
                        <FormItem>
                            ...
                            <FormControl>
                                <Input v-bind="componentField" v-model="localForm.name" type="text" placeholder="Category Name" @input="onNameInput" />
                            </FormControl>
                        </FormItem>
                    </FormField>
                    ...
                    <FormField v-slot="{ componentField }" name="slug">
                        <FormItem>
                            ...
                            <FormControl>
                                <Input v-bind="componentField" v-model="localForm.slug" type="text" placeholder="category-slug" />
                            </FormControl>
                        </FormItem>
                    </FormField>
